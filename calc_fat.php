...
<div class="d-flex body-content">
    <div class=" predcamp">
        ...
        <a href="calc.php" class="predcamp-color"> حاسبة دهون الجسم </a>
    </div>
    ...
    <div class="content">
        <div class="text-center">
            ...
            <h1> حاسبة نسبة الدهون في الجسم </h1>
            <p>هذا هي صفحة حاسبة نسبة الدهون في الجسم </p>
            <div class="">
                <form>
                    <div class="row">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header" style="border-bottom: none;">
                <h5 class="desktop-modal-header"> حساب نسبة الدهون في الجسم
                </h5>


                <h6 class="moible-modal-header">نسبة الدهون في الجسم هي:</h6>
                <button style="
    border: 0;
